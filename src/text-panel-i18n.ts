export const textPanelMessages = {
  en: {
    ...
    color: 'Text color', left: 'Align left', center: 'Align center', right: 'Align right', indentLeft: 'Left indent', indentRight: 'Right indent', indentFirst: 'First line indent', before: 'Space before paragraph', after: 'Space after paragraph', width: 'Text frame width', height: 'Text frame height (0: auto)',
  ...
  ja: {
    ...
    color: '文字色', left: '左揃え', center: '中央揃え', right: '右揃え', indentLeft: '左インデント', indentRight: '右インデント', indentFirst: '最初の行のインデント', before: '段落前のアキ', after: '段落後のアキ', width: 'テキスト枠幅', height: 'テキスト枠高さ（0：自動）',
    ...
    selection: '選択文字数', insertion: 'これから入力する文字の書式', whole: '文字ボックス全体', mixed: '混在', paragraphHint: '文字の書式は選択範囲に適用します。段落・縦横比率・回転はボックス全体に適用します。文字は枠内で自動的に折り返します。', advanced: '高度なOpenType機能・禁則処理・日本語組版は準備中です。', ligatures: '任意合字', alternates: '異体字', smallCaps: 'スモールキャップ',
  },
  'zh-CN': {
    ...
    color: '文字颜色', left: '左对齐', center: '居中', right: '右对齐', indentLeft: '左缩进', indentRight: '右缩进', indentFirst: '首行缩进', before: '段前间距', after: '段后间距', width: '文本框宽度', height: '文本框高度（0：自动）',
    ...
    selection: '已选字符数', insertion: '新输入字符的格式', whole: '整个文字对象', mixed: '混合', paragraphHint: '字符格式应用于所选文字。段落、缩放和旋转应用于整个文字框。文字会在框内自动换行。', advanced: '高级OpenType功能及东亚排版规则正在准备中。', ligatures: '可选连字', alternates: '替代字形', smallCaps: '小型大写字母',
  },
};
