export const textPanelMessages = {
  en: {
    ...
    selection: 'Selected characters', insertion: 'Style for new characters', whole: 'Whole text object', mixed: 'Mixed', paragraphHint: 'Paragraph settings apply to the whole text frame and are saved with the document.', advanced: 'Advanced OpenType features are planned.', ligatures: 'Optional ligatures', alternates: 'Stylistic alternates', smallCaps: 'Small capitals',
  },
  ja: {
    ...
    selection: '選択文字数', insertion: 'これから入力する文字の書式', whole: '文字ボックス全体', mixed: '混在', paragraphHint: '段落設定は文字ボックス全体に適用し、ドキュメントへ保存します。', advanced: '高度なOpenType機能は準備中です。', ligatures: '任意合字', alternates: '異体字', smallCaps: 'スモールキャップ',
  },
  'zh-CN': {
    ...
    selection: '已选字符数', insertion: '新输入字符的格式', whole: '整个文字对象', mixed: '混合', paragraphHint: '段落设置应用于整个文字框并保存到文档。', advanced: '高级OpenType功能正在准备中。', ligatures: '可选连字', alternates: '替代字形', smallCaps: '小型大写字母',
  },
};
