export const messages = {
  en: {
    ...
    zoom: 'Zoom relative to fit', zoomIn: 'Zoom in', zoomOut: 'Zoom out', fit: 'Fit', errorDetails: 'Error details',
    canvasStatus: { loading: 'Initializing GPU…', ready: 'Ready', browser: 'Open the macOS app to preview native GPU rendering.', unsupported: 'Native canvas support for this platform is planned.', failed: 'GPU preview failed. Please retry.', hidden: 'GPU preview paused' },
  ...
  ja: {
    ...
    zoom: '全体表示を基準とする倍率', zoomIn: '拡大', zoomOut: '縮小', fit: '全体表示', errorDetails: 'エラーの詳細',
    canvasStatus: { loading: 'GPUを準備中…', ready: '準備完了', browser: 'ネイティブGPU描画はmacOSアプリで確認できます。', unsupported: 'このOSのネイティブキャンバスは今後対応します。', failed: 'GPU描画に失敗しました。再試行してください。', hidden: 'GPU描画を一時停止中' },
  ...
  'zh-CN': {
    ...
    zoom: '相对于适应画布的缩放比例', zoomIn: '放大', zoomOut: '缩小', fit: '适应画布', errorDetails: '错误详情',
    canvasStatus: { loading: '正在初始化GPU…', ready: '就绪', browser: '请打开macOS应用以预览原生GPU渲染。', unsupported: '此平台的原生画布将在后续支持。', failed: 'GPU预览失败，请重试。', hidden: 'GPU预览已暂停' },
